...
package udacitytraining.android.com.udacity_training2.ui;
...
import udacitytraining.android.com.udacity_training2.network.FetchMoviesTask;
import udacitytraining.android.com.udacity_training2.adapter.MovieListAdapter;
import udacitytraining.android.com.udacity_training2.R;
import udacitytraining.android.com.udacity_training2.data.MovieContract;
import udacitytraining.android.com.udacity_training2.Interface.Movie;
import udacitytraining.android.com.udacity_training2.Fragment.MovieDetailFragment;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    @Override
    public void onFetchFinished(CommandKey commandkey) {
        if (commandkey instanceof FetchMoviesTask.NotifyAboutTaskCompletionCommand) {
            mAdapter.add(((FetchMoviesTask.NotifyAboutTaskCompletionCommand) commandkey).getMovies());
            updateEmptyState();
            findViewById(R.id.progress).setVisibility(View.GONE);
        }
    }
     ...
     *
     * @see FetchMoviesTask.NotifyAboutTaskCompletionCommand
     */
    public static class RetainedFragment extends Fragment implements FetchMoviesTask.Listener {
        ...
        private CommandKey mWaitingCommand = null;
        ...
        public void onFetchFinished(CommandKey commandkey) {
            if (getActivity() instanceof FetchMoviesTask.Listener && !mPaused) {
                ...
                listener.onFetchFinished(commandkey);
                mWaitingCommand = null;
            } else {
                // Save the command for later.
                mWaitingCommand = commandkey;
            }
        }
    }
}
